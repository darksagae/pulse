...
const OfficialDashboard: React.FC = () => {
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      const documentsResponse = await fetch(`${process.env.REACT_APP_API_URL || 'https://publicpulse-backend.onrender.com'}/documents/department/${departmentId}`);
  ...
  const handleStatusUpdate = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL || 'https://publicpulse-backend.onrender.com'}/documents/update-status`, {
        method: 'POST',
        headers: {
  ...
  const handleAssignDocument = async (documentId: string) => {
    try {
      const response = await fetch(`${process.env.REACT_APP_API_URL || 'https://publicpulse-backend.onrender.com'}/documents/assign`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
